            ...
            <div class="flex h-full flex-col justify-between">
              <div class="flex flex-col gap-4">
                <div class="flex flex-col mb-4">
                  <a href="<?php echo BASE_URL . '/home.php'; ?>" class="text-white text-xl font-bold leading-normal hover:text-[#fcdd53]">CN Workshop</a>
              ...
              <div class="flex flex-col gap-1 mt-auto pt-4 border-t border-[#4a4321]"> <!-- Pushes settings and logout to bottom -->
